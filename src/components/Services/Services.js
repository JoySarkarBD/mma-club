                ...
                <div className="col ">
                    <div className="card ">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">Get practical lectures and classes recorded as videos. This will create a better storage of materials for the future. And you can practice at home with these materials.</p>
                        </div>
                    </div>
                </div>
